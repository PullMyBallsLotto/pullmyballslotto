...
Adds:
- Power Play + EV simulation (uniform/weighted/fixed multipliers, 10× cap aware)
...
NO_REFUNDS_TEXT = "All sales are final and non-refundable except where required by applicable law."
